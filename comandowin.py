...
COMMANDS = {
    ...
    "EXPLORER": "Abrir el explorador de archivos",
    ...
    "GPEDIT.MSC": "Editor de directivas de grupo local (Pro)",
    "SECPOL.MSC": "Política de seguridad local (Pro)",
    "CONTROL PRINTERS": "Dispositivos e impresoras",
    "MAGNIFY": "Lupa de Windows",
    "COMPMGMT.MSC": "Administración de equipos",
    "EVENTVWR.MSC": "Visor de eventos avanzado",
    "SERVICES.MSC": "Servicios de Windows",
    "TASKSCHD.MSC": "Programador de tareas",
    "LUSRMGR.MSC": "Usuarios y grupos locales (Pro)",
    "DISKMGMT.MSC": "Administración de discos",
    "PRINTBRMUI": "Herramienta de migración de impresoras",
    "PSR": "Grabador de pasos para reproducción de problemas",
    "WF.MSC": "Firewall de Windows avanzado",
    "SYSINFO": "Resumen rápido del sistema (alias de MSINFO32)",
    "MSDT": "Herramienta de diagnóstico de Microsoft",
    "SFC /SCANNOW": "Verificador de archivos del sistema (integridad Windows)",
    "CHKDSK": "Comprobador y reparación de disco",
    "DXDIAG": "Diagnóstico DirectX",
    "CERTMGR.MSC": "Administrador de certificados",
    "RSOP.MSC": "Resultado de directivas (GPO efectivo)",
    "SECPOL.MSC": "Política de seguridad local (Pro)",
    "RESETEAERO": "Restablece la interfaz Aero de Windows",
    "SYSKEY": "Herramienta de cifrado de clave de sistema (obsoleta en W10+)",
    "GPRESULT": "Resultados de directiva de grupo en línea de comandos",
    "LOGOFF": "Cerrar sesión de usuario",
